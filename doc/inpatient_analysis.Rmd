...
Figure \@ref(fig:alert-by-age-plot) shows a boxplot of `AGE` against whether the patient has had an ACD or not (`HAS_ALERT`). The plot suggests that the means the `AGE` of the group with an ACD is higher compared to the group without an ACD (**`r mean[2,2]`** vs **`r mean[1,2]`**, respectively). Furthermore the group without an ACD has larger variance w.r.t `AGE`. 
